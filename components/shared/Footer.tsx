  ...
  return (
    <footer className="relative z-10 bg-black py-16">
      <div className="max-w-6xl mx-auto px-8">
        ...
        <div className="relative border-t border-l border-r border-gray-800 rounded-t-3xl bg-black/90 backdrop-blur-sm p-12">
          ...
          <div className="grid md:grid-cols-5 gap-8">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  {onScrollToPricing ? (
                    <button onClick={onScrollToPricing} className="text-white hover:text-white transition-colors duration-200">
                      Pricing
                    </button>
                  ) : (
