    ...
    return [
      {
        ...
        headers: [
          ...
          // Content Security Policy (CSP) - Analytics-enabled settings
          {
            ...
            value: `default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://tagmanager.google.com https://cdn.customer.io https://assets.customer.io https://app.posthog.com https://browser.sentry-cdn.com; style-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://tagmanager.google.com https://fonts.googleapis.com; img-src 'self' data: https: blob: https://www.googletagmanager.com https://www.google-analytics.com; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' https: wss: ws: http://localhost:5000 http://0.0.0.0:5000 https://www.google-analytics.com https://analytics.google.com https://region1.google-analytics.com https://region1.analytics.google.com https://stats.g.doubleclick.net https://www.googletagmanager.com https://tagmanager.google.com https://track.customer.io https://app.posthog.com https://us.i.posthog.com https://eu.i.posthog.com https://o4507902913044480.ingest.us.sentry.io https://o4507902913044480.ingest.sentry.io ${process.env.NEXT_PUBLIC_BASE_URL || ''} ${process.env.NEXT_PUBLIC_DASHBOARD_URL || ''} ${process.env.NEXT_PUBLIC_BACKEND_URL || ''} ${process.env.NEXT_PUBLIC_API_BASE_URL || ''}; worker-src 'self' blob:; media-src 'self'; object-src 'none'; base-uri 'self'; form-action 'self';`
          },
